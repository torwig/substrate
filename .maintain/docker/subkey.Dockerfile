...
LABEL io.parity.image.authors="devops-team@parity.io" \
	...
	io.parity.image.source="https://github.com/torwig/substrate/blob/${VCS_REF}/.maintain/docker/subkey.Dockerfile" \
	io.parity.image.revision="${VCS_REF}" \
	io.parity.image.created="${BUILD_DATE}" \
	io.parity.image.documentation="https://github.com/torwig/substrate/tree/${VCS_REF}/subkey"
